...
# Form implementation generated from reading ui file 'testUI_payment.ui'
#
...
class Ui_ui_PaymentPage(object):
    def setupUi(self, ui_PaymentPage):
        ui_PaymentPage.setObjectName("ui_PaymentPage")
        ui_PaymentPage.resize(948, 600)
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(11)
        ui_PaymentPage.setFont(font)
        self.centralwidget = QtWidgets.QWidget(ui_PaymentPage)
        ...
        ui_PaymentPage.setCentralWidget(self.centralwidget)
        self.statusbar = QtWidgets.QStatusBar(ui_PaymentPage)
        self.statusbar.setObjectName("statusbar")
        ui_PaymentPage.setStatusBar(self.statusbar)
        self.toolBar = QtWidgets.QToolBar(ui_PaymentPage)
        self.toolBar.setAllowedAreas(QtCore.Qt.AllToolBarAreas)
        self.toolBar.setToolButtonStyle(QtCore.Qt.ToolButtonTextOnly)
        self.toolBar.setObjectName("toolBar")
        ui_PaymentPage.addToolBar(QtCore.Qt.TopToolBarArea, self.toolBar)
        self.tool_addMoney = QtWidgets.QAction(ui_PaymentPage)
        self.tool_addMoney.setCheckable(True)
        self.tool_addMoney.setChecked(False)
        self.tool_addMoney.setObjectName("tool_addMoney")
        self.tool_payment = QtWidgets.QAction(ui_PaymentPage)
        self.tool_payment.setCheckable(True)
        self.tool_payment.setChecked(True)
        self.tool_payment.setObjectName("tool_payment")
        self.tool_updateBalance = QtWidgets.QAction(ui_PaymentPage)
        self.tool_updateBalance.setCheckable(True)
        self.tool_updateBalance.setObjectName("tool_updateBalance")
        self.tool_rebalanceInvestment = QtWidgets.QAction(ui_PaymentPage)
        self.tool_rebalanceInvestment.setCheckable(True)
        self.tool_rebalanceInvestment.setObjectName("tool_rebalanceInvestment")
        self.tool_summary = QtWidgets.QAction(ui_PaymentPage)
        ...
        self.retranslateUi(ui_PaymentPage)
        QtCore.QMetaObject.connectSlotsByName(ui_PaymentPage)

    def retranslateUi(self, ui_PaymentPage):
        _translate = QtCore.QCoreApplication.translate
        ui_PaymentPage.setWindowTitle(_translate("ui_PaymentPage", "Mobile Recharge Tracker"))
        self.label_ID.setText(_translate("ui_PaymentPage", "ID*"))
        self.label_ID_2.setText(_translate("ui_PaymentPage", "* Leave blank for new"))
        self.alabel_Date.setText(_translate("ui_PaymentPage", "Date"))
        self.alabel_Product.setText(_translate("ui_PaymentPage", "Product"))
        self.label_PaidAmt.setText(_translate("ui_PaymentPage", "Paid Amt."))
        self.label.setText(_translate("ui_PaymentPage", "Comments"))
        self.btn1_sav.setText(_translate("ui_PaymentPage", "Save / Update"))
        self.btn2_fetch.setText(_translate("ui_PaymentPage", "Fetch"))
        self.btn3_delete.setText(_translate("ui_PaymentPage", "Delete"))
        self.label_2.setText(_translate("ui_PaymentPage", "Recent Transactions"))
        self.toolBar.setWindowTitle(_translate("ui_PaymentPage", "toolBar"))
        self.tool_addMoney.setText(_translate("ui_PaymentPage", "Add Money"))
        self.tool_payment.setText(_translate("ui_PaymentPage", "Payment"))
        self.tool_updateBalance.setText(_translate("ui_PaymentPage", "Update Balance"))
        self.tool_rebalanceInvestment.setText(_translate("ui_PaymentPage", "Rebalance Investment"))
        self.tool_summary.setText(_translate("ui_PaymentPage", "Summary"))
